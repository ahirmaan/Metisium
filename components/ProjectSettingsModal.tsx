    ...
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-900 rounded-xl shadow-2xl w-full max-w-lg border border-gray-200 dark:border-gray-700">
        <div className="p-6 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
          <h2 className="text-xl font-semibold">Project Settings: <span className="text-indigo-500 dark:text-indigo-400">{project.name}</span></h2>
        ...
        <div className="p-6 bg-gray-50 dark:bg-gray-950/50 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-4 rounded-b-xl">
